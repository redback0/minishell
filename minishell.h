...
/*   Updated: 2024/05/29 10:56:17 by njackson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		run_command(t_command cmd, t_msh_dat msh); // this might need a different type
...
int			msh_exit(int ac, char *av[]); // this can send a signal to the main process to tell it to exit. I think
